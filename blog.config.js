...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '陈平安', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我的人生Tag : 不自证；不提供情绪价值；你都对', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cangdog.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '苍狗,陈平安,宛瑜,爱情公寓,博客,白云苍狗，苍狗博客', // 网站关键词 英文逗号隔开
